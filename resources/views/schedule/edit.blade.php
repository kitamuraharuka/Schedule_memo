...
@section('content')
    <div class="container">
       ...
       <div class="form-inline">
                   ...
                   <div class="form-group row">
                        <label class="col-md-2" for="string">スケジュール</label>
                        <div class="col-md-10">
                            <imput class="string" name="schedule" rows="20" >{{ $schedule_form->schedule}}</imput>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-10">
